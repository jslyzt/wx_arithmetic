...
void arithmeticMgr::init(int nMax) {
    ...
    arithmeticNode* pFunc;
    {
        pFunc = new arithmeticMaoPao();
        m_rFuncList[pFunc->getType()] = pFunc;
    }
    {
        pFunc = new arithmetic2MaoPao();
        m_rFuncList[pFunc->getType()] = pFunc;
    }
    {
        pFunc = new arithmeticInsert();
        m_rFuncList[pFunc->getType()] = pFunc;
    }
    {
        pFunc = new arithmeticDrum();
        m_rFuncList[pFunc->getType()] = pFunc;
    }
    {
        pFunc = new arithmeticTally();
        m_rFuncList[pFunc->getType()] = pFunc;
    }
    {
        pFunc = new arithmeticMerger();
        m_rFuncList[pFunc->getType()] = pFunc;
    }
    {
        pFunc = new arithmeticMergerLo();
        m_rFuncList[pFunc->getType()] = pFunc;
    }
    {
        pFunc = new arithmeticBaseM();
        m_rFuncList[pFunc->getType()] = pFunc;
    }
    {
        pFunc = new arithmeticBaseL();
        m_rFuncList[pFunc->getType()] = pFunc;
    }
    {
        pFunc = new arithmeticChoose();
        m_rFuncList[pFunc->getType()] = pFunc;
    }
    {
        pFunc = new arithmeticQuick();
        m_rFuncList[pFunc->getType()] = pFunc;
    }
    {
        pFunc = new arithmeticShell();
        m_rFuncList[pFunc->getType()] = pFunc;
    }
    {
        pFunc = new arithmeticHeap();
        m_rFuncList[pFunc->getType()] = pFunc;
    }
    {
        pFunc = new arithmeticBinaryTree();
        m_rFuncList[pFunc->getType()] = pFunc;
    }
    {
        pFunc = new arithmeticGnome();
        m_rFuncList[pFunc->getType()] = pFunc;
    }
    {
        pFunc = new arithmeticLibrary();
        m_rFuncList[pFunc->getType()] = pFunc;
    }
    {
        pFunc = new arithmeticComb();
        m_rFuncList[pFunc->getType()] = pFunc;
    }
    {
        pFunc = new arithmeticSmooth();
        m_rFuncList[pFunc->getType()] = pFunc;
    }
    {
        pFunc = new arithmeticIntro();
        m_rFuncList[pFunc->getType()] = pFunc;
    }
    {
        pFunc = new arithmeticPatience();
        m_rFuncList[pFunc->getType()] = pFunc;
    }
    ///*
